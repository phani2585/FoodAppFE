...
const App = () => {
  return (
    <CartProvider>
      <Router>
        <Header />  {/* Navigation bar for app */}
        <div className="app-container">
          <Routes>
            <Route path="/" element={<Home />} />
            <Route path="/restaurant-list" element={<RestaurantsList restaurants={restaurants} />} />
            <Route path="/cart" element={<Cart />} />
            
            {/* Dynamic route for restaurant details */}
            <Route 
              path="/restaurant/:id" 
              element={<RestaurantDetail restaurants={restaurants} />} 
            />
          </Routes>
        </div>
      </Router>
